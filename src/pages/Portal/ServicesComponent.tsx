  ...
  return (
    <div className="services-component page alternate" id={nav}>
      ...
      <div className="custom-tabs-wrapper">
        ...
        <div className="mobile-only">{generateTabContent(tabServicesForMobile)}</div>
      </div>
      ...
      <div className="custom-tabs2-wrapper">
        ...
        <div className="mobile-only">{generateTabContent(tabServicesForMobile2)}</div>
      </div>
    </div>
  );
}
