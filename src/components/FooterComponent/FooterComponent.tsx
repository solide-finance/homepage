      ...
      <div className="content">
        <div className="columns">
          <div className="mentions">
            ...
            <p>
              SolideFinance SA is incorporated in Switzerland under the number CHE-188.552.084 and affiliated with
          ...
          <div className="social">
            ...
            <p>
              ...
              >
                <svg aria-hidden="true" className="social-link" viewBox="0 0 24 24">
